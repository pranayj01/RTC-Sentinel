import type { CallQuality, QosMeasurements } from './types.js';
...
const labels: CallQuality[] = ['Excellent', 'Good', 'Fair', 'Poor', 'Critical'];
...
export function assessCallQuality(
  metric: Pick<QosMeasurements, 'rtt' | 'jitter' | 'packetLoss' | 'bitrate'>,
): QualityAssessment {
